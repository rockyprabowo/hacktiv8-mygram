...
func (q CommentQueries) GetOwnedComments(ctx context.Context, payload comment_payloads.CommentGetByOwnerPayload) (*comment_dto.PaginatedCommentWithRelationsDTO, error) {
	var (
